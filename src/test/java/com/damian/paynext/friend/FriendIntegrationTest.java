...
public class FriendIntegrationTest {
    ...
    void shouldGetFriends() throws Exception {
        ...
        friendRepository.save(
                new Friend(customer, customerFriend)
        );
        ...
        assertThat(friendDTO[0].customerId()).isEqualTo(customerFriend.getId());
    }
    ...
    void shouldAddFriend() throws Exception {
        ...
        // then
        assertThat(friendDTO).isNotNull();
        assertEquals(friendDTO.customerId(), friend.getId());
    }
    ...
    void shouldNotAddFriendWhenAlreadyExists() throws Exception {
        ...
        Friend friend = new Friend(customer, customerFriend);
    ...
    void shouldDeleteFriend() throws Exception {
        ...
        Friend givenFriend = new Friend(customer, customerFriend);
        friendRepository.save(givenFriend);

        // when
        MvcResult result = mockMvc
                .perform(
                        delete("/api/v1/friends/{id}", givenFriend.getId())
                                .header(HttpHeaders.AUTHORIZATION, "Bearer " + token))
                .andDo(print())
    ...
    @Test
    @DisplayName("Should not delete friend when not found")
    ...
    @Test
    @DisplayName("Should not delete friend when not your friend")
    void shouldNotDeleteFriendWhenNotYourFriend() throws Exception {
        ...
        Friend givenFriend = new Friend(customerA, customerFriend);
        friendRepository.save(givenFriend);
