...
public class FriendServiceTest {
    ...
    void shouldGetAllFriends() {
        ...
        Set<Friend> friendList = Set.of(
                new Friend(loggedCustomer, friend1),
                new Friend(loggedCustomer, friend2)
        );
    ...
    void shouldAddFriend() {
        ...
        Friend givenFriend = new Friend(loggedCustomer, friendCustomer);
        ...
        when(friendRepository.save(any(Friend.class)))
                .thenReturn(givenFriend);

        Friend result = friendService.addFriend(friendCustomer.getId());
    ...
    @Test
    @DisplayName("Should not add a friend when already exists")
    void shouldNotAddFriendWhenAlreadyExists() {
        ...
        when(friendRepository.friendExists(loggedCustomer.getId(), friend1.getId())).thenReturn(true);
        FriendAlreadyExistException exception = assertThrows(
    ...
    @Test
    @DisplayName("Should not delete a friend when not found")
    void shouldNotDeleteFriendWhenNotFound() {
        ...
        FriendNotFoundException exception = assertThrows(
